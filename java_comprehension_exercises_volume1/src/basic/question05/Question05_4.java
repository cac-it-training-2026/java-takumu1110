...
public class Question05_4 {
	...
	public static void main(String[] args) throws IOException {
		...
		String strsugaku = reader.readLine();
		int math = Integer.parseInt(strsugaku);
		System.out.println("国語の試験の点数を入力してください。");
		String strkokugo = reader.readLine();
		int japanese = Integer.parseInt(strkokugo);
